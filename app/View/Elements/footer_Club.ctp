...
<?php echo $this->Html->script(array('vendor/modernizr-2.6.2-respond-1.1.0.min', 'vendor/bootstrap.min')); ?>
<?php echo $this->Html->script(array('docs/vendor/prism', 'docs/index', 'build/js/bootstrap-switch')); ?>
<?php echo $this->Html->script(array('plugins', 'main')); ?>
<script>
