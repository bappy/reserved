...
<script type="text/javascript">            
    jQuery(document).ready(function() {
        jQuery("#edit_events_category").validationEngine('attach');
    });
</script>
<div class="topNav">
    <ul class="nav">
        ...
        <nav id="primary-nav">
            <ul>
                ...
                <li>
                    ...
                    <h4>Categories</h4>
                    <?php echo $this->Form->create('Category', array('url' => array('controller' => 'Events', 'action' => 'add_events_category'), 'id' => 'edit_events_category')); ?>
                    <div class="row-fluid">
                        <div class="span9">
