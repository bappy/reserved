...
<script type="text/javascript">            
    jQuery(document).ready(function() {
        jQuery("#add_club_bottles_category").validationEngine('attach');
    });
</script>
<div class="topNav">
    <ul class="nav">
        ...
        <nav id="primary-nav">
            <ul>
                ...
                <li>
                    ...
                    <h4>Categories</h4>
                    <?php echo $this->Form->create('Category', array('url' => array('controller' => 'clubBottles', 'action' => 'add_bottles_category'), 'id' => 'add_club_bottles_category')); ?>
                    <div class="row-fluid">
                        <div class="span9">
                    ...
                    <?php if (!empty($left_categories)): ?>
                        <ul style="display:block;">
                            <?php foreach ($left_categories as $left_category): ?>
                                <li>
                                    <a class="bottle_category_name" href="<?php echo $this->Html->url(array('controller' => 'clubBottles', 'action' => 'index', $left_category['Category']['id'])); ?>"><?php echo $left_category['Category']['category_name']; ?></a>
