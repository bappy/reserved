...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $this->Form->value('Booking.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('Booking.id'))); ?></li>
