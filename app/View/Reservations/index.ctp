...
<?php endforeach; ?>
    ...
    function reservation_detail_popup( id ){
       $.ajax({
            url:'<?php echo $this->Html->url(array('controller' => 'Reservations', 'action' => 'reservation_details')) ?>',
            dataType : 'html',
            type : 'POST',
            data : 'id='+id,
    ...
    $(document).ready(function() {
	 ...
	 $(document).on('click','#ajax_accept', function(e) {
		...
		if(answer)
		{
			...
			$.ajax({
				type: "POST",
				url: myBaseUrl+"/Reservations/ajaxAccept/",
				data: {id: id,type:type}
				 ...
				 {
				   $('#myModal').modal('hide');
				   $(location).attr('href','<?php echo $this->Form->url('/Reservations') ?>')
				 }
				 else
				 {
					 //alert("I am testing");
        ...
        <div class="left-containr">
            <div id="side-tab-menu" class="tab-pane active">
                ...
                <nav id="primary-nav">
                    <ul>
                        <li>
                            <a href="#"><i class="glyphicon-notes"></i>Today</a>
                        </li>
                        <li>
                            <a class="active" href="#"><i class="glyphicon-table"></i>This week</a>
                        </li>
                        <li>
                            <a href="#"><i class="glyphicon-calendar"></i>This month</a>
                        </li>
                    </ul>
                </nav>
