...
<?php echo $this->Form->create('ClubOpenDay');?>
	<fieldset>
 		<legend><?php echo __('Admin Edit Club Open Day'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete'), array('action' => 'delete', $this->Form->value('ClubOpenDay.id')), null, sprintf(__('Are you sure you want to delete # %s?'), $this->Form->value('ClubOpenDay.id'))); ?></li>
