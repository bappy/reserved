...
<script type="text/javascript">
    ...
    $(document).on('click', '#admin_ajax_btn', function(e) {
        e.preventDefault();
        ...
        $.ajax({
            ...
            //alert(msg);
            $("#Redirecting").show();
            $(location).attr('href', '<?php echo $this->Form->url('/admin/Clubs/add') ?>')
            $.modal.close();
            hideajax();
        });
        return false;
...
<cake:nocache>
    <div class="row-fluid">
        ...
        <div id="page-content-right" class="eqHight">
            <?php echo $this->element('admin_top', array("club_name" => $club_name)); ?>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                <div class="phoneBanner">                                                    
                                                    <img style="margin:0;" src="<?php echo $this->webroot . 'img/profile/' . $profile_photo["photos"];?>" />
                                                </div>
                                        ...
                                        <div class="row-fluid">
                                            <div class="span12">
                                                ...
                                                <div class="phoneDateBar">
                                                    <?php  foreach($clubs[0]['ClubOpenDay'] as $key => $ClubOpenDay){
			...
			<?php echo $this->Utility->OpenClose($daysArr); ?>
                        ...
                        <div class="row-fluid">
                            <div id='content'>
                                ...
                                <div id="basic-modal-content">
                                    <?php $this->Utility->adminbasicmodal(); ?>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row-fluid">
                    <div class="span12">
                        <div id="EditModal">
                            <?php echo $this->Utility->AdminEditmodal($clubExceptions); ?>
                        </div>
                    </div>							
                </div>
                <div class="row-fluid">
