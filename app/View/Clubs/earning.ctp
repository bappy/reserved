...
<div class="row-fluid">
    <div id="page-sidebar-left" class="eqHight">
        <div class="topNav">
            <ul class="nav">
                <li><a href="javascript:void(0);">Hooray Henry's</a></li>
            </ul>
            <div class="clear">&nbsp;</div>
        </div>
                ...
                <div class="row-fluid">
                    <div class="block block-last">
                        <div class="row-fluid">                           
                            ...
                            <!--                                 <div class="row-fluid">
                                            <div class="span1" for="">Date:</div>
                                                                <div class="span9 input-append date input-datepicker">
                                                                              //<?php echo $this->Form->input('from', array('style' => 'width:30%','type' => 'text', 'required' => false, 'label' => false, 'id' => 'datepicker', 'class' => 'input-medium', 'div' => false)); ?>
                                                                    -//<?php echo $this->Form->input('to', array('style' => 'width:30%','type' => 'text', 'required' => false, 'label' => false, 'id' => 'datepicker1', 'class' => 'input-medium', 'div' => false)); ?>
                            ...
                            <button type="submit" class="btn">Search</button>&nbsp;<a download="somedata.csv" href="javascript:void(0);" onclick="return ExcellentExport.csv(this, 'datatable');">Spreed Sheet</a>
